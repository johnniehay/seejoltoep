...
import { /*Pages,*/ PuckPages } from './collections/Pages'
...
import { Beursies } from "@/collections/Beursies";
...
export default buildConfig({
    admin: {
        components: {
          ...
          beforeLogin: ["@/components/SignInWithAuthjsButton#SignInWithAuthjsButton"],
          graphics: {
