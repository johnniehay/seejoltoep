  ...
  return (
    <Sheet onOpenChange={setIsOpen} open={isOpen}>
      ...
      <SheetContent className="flex flex-col">
        <SheetHeader>
          <SheetTitle>My Mandjie</SheetTitle>

          <SheetDescription>Bestuur u mandjie hier, voeg items by om die totaal te sien.</SheetDescription>
        </SheetHeader>

        {!cart || cart?.items?.length === 0 ? (
          <div className="text-center flex flex-col items-center gap-2">
            <ShoppingCart className="h-16" />
            <p className="text-center text-2xl font-bold">U mandjie is leeg.</p>
          </div>
        ) : (
