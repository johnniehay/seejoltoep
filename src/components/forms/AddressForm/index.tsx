  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <div className="flex flex-col gap-4 mb-8">
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <FormItem>
            ...
            <Input
              ...
              {...register('firstName', { required: 'Voornaam is verpligtend.' })}
            />
          ...
          <FormItem>
            ...
            <Input
              ...
              id="lastName"
              {...register('lastName', { required: 'Van is verpligtend.' })}
            />
        ...
        <FormItem>
          <Label htmlFor="company">Maatskappy</Label>
          <Input id="company" autoComplete="organization" {...register('company')} />
          {errors.company && <FormError message={errors.company.message} />}
        </FormItem>

        <FormItem>
          <Label htmlFor="addressLine1">Adresreël 1*</Label>
          <Input
            id="addressLine1"
            autoComplete="address-line1"
            {...register('addressLine1', { required: 'Adresreël 1 is verpligtend.' })}
          />
          {errors.addressLine1 && <FormError message={errors.addressLine1.message} />}
        </FormItem>

        <FormItem>
          <Label htmlFor="addressLine2">Adresreël 2</Label>
        ...
        <FormItem>
          ...
          <Input
            ...
            {...register('city', { required: 'Stad is verpligtend.' })}
          />
          {errors.city && <FormError message={errors.city.message} />}
        </FormItem>

        <FormItem>
          <Label htmlFor="state">Provinsie</Label>
          <Input id="state" autoComplete="address-level1" {...register('state')} />
          {errors.state && <FormError message={errors.state.message} />}
        </FormItem>

        <FormItem>
          <Label htmlFor="postalCode">Poskode*</Label>
          <Input
            id="postalCode"
            {...register('postalCode', { required: 'Poskode is verpligtend.' })}
          />
