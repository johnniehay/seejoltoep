...
export const KennisgewingManagementPermissions = ["create:kennisgewing", "update:kennisgewing", "remove:kennisgewing"] as const
export const KennisgewingLogManagementPermissions = ["create:kennisgewinglog", "update:kennisgewinglog", "remove:kennisgewinglog", "view:kennisgewinglog"] as const
export const GroepeManagementPermissions = ["create:groepe", "update:groepe", "remove:groepe", "view:groepe"] as const
export const BeursieManagementPermissions = ["create:beursie", "update:beursie", "view:beursie", "create:beursietransaksie", "view:beursietransaksie", "update:systembeursies"] as const
...
export const AdminOnlyPermissions = ["admin", "view:users", "create:users", "update:users", "remove:users","update:systemsettings", ...AktiwiteitManagementPermissions,...LocationManagementPermissions,...InklokManagementPermissions,...KennisgewingLogManagementPermissions,...BeursieTransaksieAdminPermissions] as const
