...
import { IconListCheck, IconLogin2, IconQrcode, IconSearch } from '@tabler/icons-react'
...
export default async function TempHome() {
  ...
  return (
    <div className="container mx-auto py-10 min-h-screen flex flex-col items-center justify-center gap-8">
      ...
      {!user && (
        <Button asChild className="h-40 text-4xl font-bold rounded-3xl gap-8 w-full max-w-4xl" variant="default">
          <Link href="/lid">
            <IconLogin2 size={48} />
            <span>Teken in</span>
          </Link>
