    ...
    <div className="">
      <div className="flex gap-8 justify-between items-center mb-6">
        ...
        <h1 className="text-sm uppercase font-mono px-2 bg-primary/10 rounded tracking-[0.07em]">
          <span className="">{`Bestelling #${order.id}`}</span>
        </h1>
      </div>
      ...
      <div className="bg-card border rounded-lg px-6 py-4 flex flex-col gap-12">
        <div className="flex flex-col gap-6 lg:flex-row lg:justify-between">
          <div className="">
            <p className="font-mono uppercase text-primary/50 mb-1 text-sm">Besteldatum</p>
            <p className="text-lg">
          ...
          <div className="">
            <p className="font-mono uppercase text-primary/50 mb-1 text-sm">Totaal</p>
            ...
            <ul className="flex flex-col gap-6">
              {order.items?.map((item, index) => {
                ...
                if (!item.product || typeof item.product !== 'object') {
                  return <div key={index}>Hierdie item is nie meer beskikbaar nie.</div>
                }
        ...
        {order.shippingAddress && (
          <div>
            <h2 className="font-mono text-primary/50 mb-4 uppercase text-sm">Afleweringsadres</h2>
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    description: `Besonderhede vir bestelling ${id}.`,
